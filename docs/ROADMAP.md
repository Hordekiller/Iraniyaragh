...
| 4 | Shipment → Tracking → essential notifications | #310 covers manual one-package dispatch and customer/staff tracking; delivery confirmation and provider-backed essential notifications follow separately. Complete one fixture-free staging purchase through tracking. |
