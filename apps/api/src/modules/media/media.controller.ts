...
export class MediaController {
  ...
  initiateUpload(@CurrentPrincipal() principal: AuthPrincipalContext, @Headers("idempotency-key") idempotencyKey: string, @Param("productId") productId: string, @Body() input: ProductMediaUploadDto): Promise<ProductMediaUploadResponse> {
  ...
  @RequireAuthentication("STAFF_MFA")
  @RequirePermission("catalog.media.write")
  confirmUpload(@CurrentPrincipal() principal: AuthPrincipalContext, @Headers("idempotency-key") idempotencyKey: string, @Param("productId") productId: string, @Param("mediaId") mediaId: string, @Body() input: ProductMediaConfirmDto): Promise<ProductMediaConfirmResponse> {
  ...
  @RequireAuthentication("STAFF_MFA")
  @RequirePermission("catalog.media.write")
  updateMetadata(@CurrentPrincipal() principal: AuthPrincipalContext, @Headers("idempotency-key") idempotencyKey: string, @Param("productId") productId: string, @Param("mediaId") mediaId: string, @Body() input: ProductMediaMetadataDto): Promise<AdminProductMediaResponse> {
  ...
  @RequireAuthentication("STAFF_MFA")
  @RequirePermission("catalog.media.write")
  reorder(@CurrentPrincipal() principal: AuthPrincipalContext, @Headers("idempotency-key") idempotencyKey: string, @Param("productId") productId: string, @Body() input: ProductMediaReorderDto): Promise<AdminProductMediaListResponse> {
  ...
  @RequireAuthentication("STAFF_MFA")
  @RequirePermission("catalog.media.write")
  archive(@CurrentPrincipal() principal: AuthPrincipalContext, @Headers("idempotency-key") idempotencyKey: string, @Param("productId") productId: string, @Param("mediaId") mediaId: string, @Body() input: ProductMediaArchiveDto): Promise<AdminProductMediaResponse> {
  ...
  @ApiParam({ name: "productId", type: String })
  @ApiParam({ name: "mediaId", type: String })
  @ApiBody({ type: ProductMediaPrimaryDto })
  @ApiHeader(idempotencyHeader)
  @RequireAuthentication("STAFF_MFA")
  @RequirePermission("catalog.media.write")
  setPrimary(@CurrentPrincipal() principal: AuthPrincipalContext, @Headers("idempotency-key") idempotencyKey: string, @Param("productId") productId: string, @Param("mediaId") mediaId: string, @Body() input: ProductMediaPrimaryDto): Promise<AdminProductMediaListResponse> {
    return this.media.setPrimary(principal.userId, idempotencyKey, productId, mediaId, input);
  }
}
