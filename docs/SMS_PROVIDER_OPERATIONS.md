...
- #114: provider port/adapter, deterministic fake, Auth integration, truthful
  read-only environment projection, diagnostics boundary, tests and runbook are
  merged; private provider activation evidence remains.
