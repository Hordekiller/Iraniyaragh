...
- `apps/web`: customer storefront. Current React/Vite UI is preserved as the visual
  baseline and migrates route-by-route to Next.js under ADR-0012; the API remains the
